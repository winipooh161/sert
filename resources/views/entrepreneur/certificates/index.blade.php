                    ...
                    <tbody>
                        @forelse ($certificates as $certificate)
                            <tr>
                                ...
                                <td class="align-middle d-none d-md-table-cell">{{ $certificate->template ? $certificate->template->name : 'Шаблон удален' }}</td>
                                <td class="align-middle">{{ number_format($certificate->amount, 0, '.', ' ') }} ₽</td>
                                <td class="align-middle d-none d-lg-table-cell">
                                    <span class="small">
                                        {{ is_string($certificate->valid_from) ? $certificate->valid_from : $certificate->valid_from->format('d.m.Y') }} - 
                                        {{ is_string($certificate->valid_until) ? $certificate->valid_until : $certificate->valid_until->format('d.m.Y') }}
                                    </span>
                                </td>

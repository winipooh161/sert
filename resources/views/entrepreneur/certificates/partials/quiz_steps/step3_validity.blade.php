<div class="quiz-step" id="quizStep3">
    ...
    <div id="custom_date_selector" class="mb-3 mt-3 d-none">
        ...
        <input type="date" class="form-control form-control-lg @error('valid_until') is-invalid @enderror" 
    ...
    <div class="card bg-light mt-3">
        <div class="card-body text-center">
            ...
            <h5 class="card-title" id="displayValidUntil">{{ now()->addMonths(3)->format('d.m.Y') }}</h5>
            <p class="card-text small" id="daysRemaining">Осталось {{ now()->addMonths(3)->diffInDays(now()) }} дней</p>
        </div>
    </div>
</div>

                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="phone" type="tel" class="form-control border-start-0 maskphone @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="tel" placeholder="+7 (___) ___-__-__">

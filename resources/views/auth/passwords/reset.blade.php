                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input id="phone" type="tel" class="form-control border-start-0 maskphone @error('phone') is-invalid @enderror" name="phone" value="{{ $phone ?? old('phone') }}" required autocomplete="tel" autofocus placeholder="+7 (___) ___-__-__" readonly>
                        ...
                        <div class="mb-4">
                            <label for="password" class="form-label fw-medium">{{ __('Новый пароль') }}</label>

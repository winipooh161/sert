        ...
        <div class="col-md-8 col-lg-6">
            <div class="card bg-white shadow-sm border-0 rounded-4 overflow-hidden">
                <div class="card-header bg-transparent border-0 pt-4 text-center">
                    <h4 class="gradient-text fw-bold mb-1"><?php echo e(__('Сброс пароля')); ?></h4>
                </div>
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e($phone ?? old('phone')); ?>" required autocomplete="tel" autofocus placeholder="+7 (___) ___-__-__" readonly>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            <label for="password" class="form-label fw-medium"><?php echo e(__('Новый пароль')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\sert\resources\views\auth\passwords\reset.blade.php ENDPATH**/ ?>
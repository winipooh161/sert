...
<div class="container-fluid">
    ...
    <?php $__env->startComponent('components.page-header'); ?>
        <?php $__env->slot('title', 'Настройки'); ?>
        <?php $__env->slot('subtitle', 'Управление настройками вашего аккаунта'); ?>
    <?php echo $__env->renderComponent(); ?>
        ...
        <div class="col-md-9">
            <div class="tab-content" id="settingsTabContent">
                        ...
                        <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="avatar-upload">
                                            <div class="avatar-preview rounded-circle mb-3 mx-auto">
                                                <?php if(Auth::user()->avatar): ?>
                                                    <div id="imagePreview" style="background-image: url(<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>);"></div>
                                                <?php else: ?>
                                                    <div id="imagePreview" class="bg-primary bg-opacity-10 d-flex align-items-center justify-content-center text-primary">
                                                        <span class="h1"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <div class="col-md-9">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" class="form-control maskphone" id="phone" name="phone" value="<?php echo e(Auth::user()->phone ?? ''); ?>">
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="company" name="company" value="<?php echo e(Auth::user()->company ?? ''); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="position" class="form-label">Должность</label>
                                    <input type="text" class="form-control" id="position" name="position" value="<?php echo e(Auth::user()->position ?? ''); ?>">
                                </div>
                                <div class="col-12">
                                    <label for="bio" class="form-label">О себе</label>
                                    <textarea class="form-control" id="bio" name="bio" rows="3"><?php echo e(Auth::user()->bio ?? ''); ?></textarea>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="notifications" role="tabpanel" aria-labelledby="notifications-tab">
                    <?php $__env->startComponent('components.card', ['title' => 'Настройки уведомлений']); ?>
                ...
                <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                    <?php $__env->startComponent('components.card', ['title' => 'Смена пароля']); ?>
                    ...
                    <?php $__env->startComponent('components.card', ['title' => 'Двухфакторная аутентификация', 'class' => 'mt-4']); ?>
                        <div class="alert alert-info">
                    ...
                    <?php $__env->startComponent('components.card', ['title' => 'Активные сеансы', 'class' => 'mt-4']); ?>
                ...
                <div class="tab-pane fade" id="payments" role="tabpanel" aria-labelledby="payments-tab">
                    <?php $__env->startComponent('components.card', ['title' => 'Платежные данные']); ?>
                        <div class="alert alert-info">
                            <i class="fa-solid fa-info-circle me-2"></i>
                    ...
                    <?php $__env->startComponent('components.card', ['title' => 'История платежей', 'class' => 'mt-4']); ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                ...
                <div class="tab-pane fade" id="appearance" role="tabpanel" aria-labelledby="appearance-tab">
                    <?php $__env->startComponent('components.card', ['title' => 'Настройки интерфейса']); ?>
                        <form>
                            <div class="mb-4">
                ...
                <div class="tab-pane fade" id="data" role="tabpanel" aria-labelledby="data-tab">
                    <?php $__env->startComponent('components.card', ['title' => 'Управление данными']); ?>
                        <div class="mb-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Пожалуйста, введите <strong><?php echo e(Auth::user()->email); ?></strong> для подтверждения:</p>
                <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirm_email').addEventListener('input', function() {
        ...
        confirmDeleteBtn.disabled = this.value !== "<?php echo e(Auth::user()->email); ?>";
    });
...
<?php echo $__env->make('layouts.lk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\sert\resources\views\profile\settings.blade.php ENDPATH**/ ?>
<div class="card border-0 shadow-sm rounded-4 certificate-quiz-container">
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('entrepreneur.certificates.store', $template)); ?>" id="mobileCertificateForm" class="mobile-form" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>

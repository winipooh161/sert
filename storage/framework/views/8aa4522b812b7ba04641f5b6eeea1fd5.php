...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-3 py-md-4">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $certificatesByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $dateGroupCertificates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-3">
                    ...
                    <?php $__currentLoopData = $dateGroupCertificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col certificate-item" data-recipient-name="<?php echo e($certificate->recipient_name); ?>"
                                ...
                                <a href="<?php echo e(route('certificates.public', $certificate->uuid)); ?>" class="card-link"
                                    ...
                                    <div class="certificate-cover-wrapper">
                                        ...
                                        <small class="text-white certificate-time-badge">
                                            ...
                                            <?php echo e($certificate->created_at->format('H:i')); ?>
                    ...
                    <div class="card border-0 rounded-4 shadow-sm">
                        <div class="card-body p-4 text-center">
                            <div class="d-flex flex-column align-items-center py-4">
                                ...
                                <p class="text-muted mb-3">Создайте свой первый сертификат, нажав на кнопку выше</p>
        ...
        <?php if($certificatesByDate->isEmpty()): ?>
            <div class="row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-3">
                <div class="col">
                    <a href="<?php echo e(route('entrepreneur.certificates.select-template')); ?>" class="card-link">

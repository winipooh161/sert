...
<section class="position-relative" id="how-it-works">
    ...
    <div class="container px-4">
        ...
        <div class="text-center mt-5">
            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg rounded-pill">Попробовать бесплатно</a>
        </div>
    </div>
</section>
<?php /**PATH C:\OSPanel\domains\sert\resources\views/welcome/how_it_works.blade.php ENDPATH**/ ?>
...
<div class="container-fluid py-3 py-md-4">
    ...
    <nav aria-label="breadcrumb" class="mb-2 mb-md-3">
        <ol class="breadcrumb small">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('entrepreneur.certificates.show', $certificate)); ?>">Просмотр сертификата</a></li>
            <li class="breadcrumb-item active" aria-current="page">Подготовка к печати</li>
        </ol>
    </nav>
    
    <h1 class="fs-4 fs-md-3 fw-bold mb-3 mb-md-4">Печать сертификата № <?php echo e($certificate->certificate_number); ?></h1>
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 rounded-4 shadow-sm">
                <div class="card-body p-3 p-md-4">
                    ...
                    <form method="POST" action="<?php echo e(route('entrepreneur.certificates.print.generate', $certificate)); ?>" target="_blank">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select <?php $__errorArgs = ['orientation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="orientation" name="orientation" required>
                                ...
                                <div class="card border bg-light p-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-4">
                                            ...
                                            <input type="number" class="form-control <?php $__errorArgs = ['custom_width'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                id="custom_width" name="custom_width" value="<?php echo e(old('custom_width', 210)); ?>" min="50" max="1000" step="1">
                                            <?php $__errorArgs = ['custom_width'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="number" class="form-control <?php $__errorArgs = ['custom_height'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                id="custom_height" name="custom_height" value="<?php echo e(old('custom_height', 297)); ?>" min="50" max="1000" step="1">
                                            <?php $__errorArgs = ['custom_height'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('entrepreneur.certificates.show', $certificate)); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="preview-container bg-light rounded p-3" style="position: relative; overflow: hidden;">
                        <div id="preview-wrapper" style="transform-origin: top left; transition: all 0.3s ease;">
                            <iframe id="preview-frame" src="<?php echo e(route('template.preview', [
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 rounded-4 shadow-sm">
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="mb-3">
                        <img src="<?php echo e($certificate->template->image ? asset('storage/' . $certificate->template->image) : asset('images/certificate-placeholder.jpg')); ?>" 
                             class="img-fluid rounded-3" alt="<?php echo e($certificate->template->name); ?>">
                    </div>
                    
                    <dl class="row mb-0">
                        <dt class="col-sm-5">Шаблон:</dt>
                        <dd class="col-sm-7"><?php echo e($certificate->template->name); ?></dd>
                        
                        <dt class="col-sm-5">Номинал:</dt>
                        <dd class="col-sm-7"><?php echo e(number_format($certificate->amount, 0, '.', ' ')); ?> ₽</dd>
                        
                        <dt class="col-sm-5">Получатель:</dt>
                        <dd class="col-sm-7"><?php echo e($certificate->recipient_name); ?></dd>
                        
                        <dt class="col-sm-5">Действителен до:</dt>
                        <dd class="col-sm-7"><?php echo e($certificate->valid_until->format('d.m.Y')); ?></dd>
            ...
            <div class="card border-0 rounded-4 shadow-sm mt-3">
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('entrepreneur.certificates.print.generate', [$certificate, 'format' => 'a4', 'orientation' => 'landscape'])); ?>" 
                           class="btn btn-outline-primary btn-sm" target="_blank">
                            <i class="fa-solid fa-file-pdf me-2"></i>A4 Альбомная
                        </a>
                        <a href="<?php echo e(route('entrepreneur.certificates.print.generate', [$certificate, 'format' => 'a5', 'orientation' => 'landscape'])); ?>" 
                           class="btn btn-outline-primary btn-sm" target="_blank">
                            <i class="fa-solid fa-file-pdf me-2"></i>A5 Альбомная
                        </a>
                        <a href="<?php echo e(route('entrepreneur.certificates.print.generate', [$certificate, 'format' => 'a6', 'orientation' => 'landscape'])); ?>" 
                           class="btn btn-outline-primary btn-sm" target="_blank">
...
<?php echo $__env->make('layouts.lk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\sert\resources\views\entrepreneur\certificates\print-options.blade.php ENDPATH**/ ?>
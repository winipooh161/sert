                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="card template-card shadow-sm h-100">
                            ...
                            <div class="card-body p-2 p-sm-3 d-flex flex-column">
                                ...
                                <a href="<?php echo e(route('photo.editor')); ?>?template=<?php echo e($template->id); ?>" class="btn btn-primary btn-sm">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered modal-fullscreen-md-down">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="<?php echo e(route('photo.editor')); ?>?template=<?php echo e($template->id); ?>" class="btn btn-sm btn-primary">
                                            Выбрать шаблон
                                        </a>
                                    </div>
                                </div>

                ...
                <div class="bg-transparent rounded-4 p-5 text-center position-relative overflow-hidden cta-card">
                    <div class="position-relative z-2">
                        ...
                        <div class="d-flex flex-wrap justify-content-center gap-3">
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg px-5 py-3 hover-lift">Начать бесплатно</a>
...
<?php /**PATH C:\OSPanel\domains\sert\resources\views\welcome\cta.blade.php ENDPATH**/ ?>
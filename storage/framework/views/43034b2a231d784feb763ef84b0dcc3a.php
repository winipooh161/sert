    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.animation-effects.store')); ?>" method="POST" id="effectForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="emoji" <?php echo e(old('type') == 'emoji' ? 'selected' : ''); ?>>Эмодзи (смайлики)</option>
                                    <option value="confetti" <?php echo e(old('type') == 'confetti' ? 'selected' : ''); ?>>Конфетти</option>
                                    <option value="snow" <?php echo e(old('type') == 'snow' ? 'selected' : ''); ?>>Снежинки</option>
                                    <option value="fireworks" <?php echo e(old('type') == 'fireworks' ? 'selected' : ''); ?>>Фейерверк</option>
                                    <option value="bubbles" <?php echo e(old('type') == 'bubbles' ? 'selected' : ''); ?>>Пузыри</option>
                                    <option value="leaves" <?php echo e(old('type') == 'leaves' ? 'selected' : ''); ?>>Листья</option>
                                    <option value="stars" <?php echo e(old('type') == 'stars' ? 'selected' : ''); ?>>Звезды</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                id="particles" name="particles" value="<?php echo e(old('particles', '🎉,🎊,✨,🎁,💫,🎈')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="center" <?php echo e(old('direction') == 'center' ? 'selected' : ''); ?>>К центру</option>
                                    <option value="top" <?php echo e(old('direction') == 'top' ? 'selected' : ''); ?>>Вверх</option>
                                    <option value="bottom" <?php echo e(old('direction') == 'bottom' ? 'selected' : ''); ?>>Вниз</option>
                                    <option value="random" <?php echo e(old('direction') == 'random' ? 'selected' : ''); ?>>Случайно</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="slow" <?php echo e(old('speed') == 'slow' ? 'selected' : ''); ?>>Медленно</option>
                                    <option value="normal" <?php echo e(old('speed', 'normal') == 'normal' ? 'selected' : ''); ?>>Стандартно</option>
                                    <option value="fast" <?php echo e(old('speed') == 'fast' ? 'selected' : ''); ?>>Быстро</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="color" name="color" value="<?php echo e(old('color', '#ffcc00')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                    id="size_min" name="size_min" value="<?php echo e(old('size_min', 16)); ?>" min="8" max="64" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="size_max" name="size_max" value="<?php echo e(old('size_max', 32)); ?>" min="8" max="100" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="quantity" name="quantity" value="<?php echo e(old('quantity', 50)); ?>" min="10" max="200" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" value="1" 
                                        id="is_active" name="is_active" <?php echo e(old('is_active', '1') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.lk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\sert\resources\views/admin/animation-effects/create.blade.php ENDPATH**/ ?>
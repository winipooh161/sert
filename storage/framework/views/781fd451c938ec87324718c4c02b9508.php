...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
        <div>
            <h1 class="h2 mb-1">Добро пожаловать, <?php echo e(Auth::user()->name); ?>!</h1>
            <p class="text-muted">Управление сертификатами и аналитика</p>
        </div>
        <div class="d-flex mt-3 mt-md-0">
            <a href="<?php echo e(route('entrepreneur.certificates.select-template')); ?>" class="btn btn-primary">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card border-0 rounded-4 shadow-sm hover-lift h-100">
                <div class="card-body p-4">
                    ...
                    <h2 class="mb-0"><?php echo e($totalCertificates); ?></h2>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card border-0 rounded-4 shadow-sm hover-lift h-100">
                <div class="card-body p-4">
                    ...
                    <h2 class="mb-0"><?php echo e($activeCertificates); ?></h2>
                    <div class="progress mt-3" style="height: 6px;">
                        <div class="progress-bar bg-success" role="progressbar" 
                             style="width: <?php echo e($totalCertificates > 0 ? ($activeCertificates / $totalCertificates * 100) : 0); ?>%" 
                             aria-valuenow="<?php echo e($totalCertificates > 0 ? ($activeCertificates / $totalCertificates * 100) : 0); ?>" 
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <p class="text-muted small mt-3 mb-0">
                        <?php echo e($totalCertificates > 0 ? number_format($activeCertificates / $totalCertificates * 100, 0) : 0); ?>% от общего числа
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card border-0 rounded-4 shadow-sm hover-lift h-100">
                <div class="card-body p-4">
                    ...
                    <h2 class="mb-0"><?php echo e($usedCertificates); ?></h2>
                    <div class="progress mt-3" style="height: 6px;">
                        <div class="progress-bar bg-secondary" role="progressbar" 
                             style="width: <?php echo e($totalCertificates > 0 ? ($usedCertificates / $totalCertificates * 100) : 0); ?>%" 
                             aria-valuenow="<?php echo e($totalCertificates > 0 ? ($usedCertificates / $totalCertificates * 100) : 0); ?>" 
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <p class="text-muted small mt-3 mb-0">
                        <?php echo e($totalCertificates > 0 ? number_format($usedCertificates / $totalCertificates * 100, 0) : 0); ?>% от общего числа
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card border-0 rounded-4 shadow-sm hover-lift h-100">
                <div class="card-body p-4">
                    ...
                    <h2 class="mb-0"><?php echo e(number_format($totalAmount, 0, '.', ' ')); ?> ₽</h2>
                ...
                <div class="card-body d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="w-100">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="fw-bold"><?php echo e($activeCertificates); ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold"><?php echo e($expiredCertificates); ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold"><?php echo e($usedCertificates); ?></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card border-0 rounded-4 shadow-sm mb-4">
        <div class="card-header bg-transparent d-flex justify-content-between align-items-center pt-4">
            ...
            <a href="<?php echo e(route('entrepreneur.certificates.index')); ?>" class="btn btn-sm btn-outline-primary">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentCertificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-4 fw-medium"><?php echo e($certificate->certificate_number); ?></td>
                                <td><?php echo e($certificate->recipient_name); ?></td>
                                <td><?php echo e($certificate->template->name); ?></td>
                                <td><?php echo e(number_format($certificate->amount, 0, '.', ' ')); ?> ₽</td>
                                <td>
                                ...
                                <td class="text-end pe-4">
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?php echo e(route('entrepreneur.certificates.show', $certificate)); ?>" class="btn btn-outline-primary" data-bs-toggle="tooltip" title="Просмотр">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('entrepreneur.certificates.edit', $certificate)); ?>" class="btn btn-outline-secondary" data-bs-toggle="tooltip" title="Редактировать">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var statusChart = new Chart(ctxStatus, {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    <?php echo e($activeCertificates ?? 0); ?>, 
                    <?php echo e($expiredCertificates ?? 0); ?>, 
                    <?php echo e($usedCertificates ?? 0); ?>
...
<?php echo $__env->make('layouts.lk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\sert\resources\views\entrepreneur\dashboard.blade.php ENDPATH**/ ?>